...
type Tab = 'tvm' | 'amortization' | 'cashflow' | 'notes';
...
function App() {
  const [activeTab, setActiveTab] = useState<Tab>('tvm');
  ...
  return (
    <main className="app-shell">
      ...
      <div className="tabs-bar" role="tablist" aria-label="Worksheets">
        <button
          role="tab"
          aria-selected={activeTab === 'tvm'}
          className={activeTab === 'tvm' ? 'tab-btn active' : 'tab-btn'}
        ...
        <button
          ...
          className={activeTab === 'amortization' ? 'tab-btn active' : 'tab-btn'}
        ...
        <button
          ...
          className={activeTab === 'cashflow' ? 'tab-btn active' : 'tab-btn'}
      ...
      <div className="tab-content-wrapper">
        {activeTab === 'tvm' && (
          <section className="tab-panel" aria-labelledby="tab-tvm">
        ...
        {activeTab === 'amortization' && (
          <section className="tab-panel" aria-labelledby="tab-amortization">
        ...
        {activeTab === 'cashflow' && (
          <section className="tab-panel" aria-labelledby="tab-cashflow">
        ...
        {activeTab === 'notes' && (
          <section className="tab-panel" aria-labelledby="tab-notes">
